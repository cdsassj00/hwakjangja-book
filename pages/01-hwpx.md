...
이 이야기가 공문 한 종류에만 해당하지 않는다는 점이 중요합니다. 인사팀에는 연말이면 재직증명서와 경력증명서 요청이 몰립니다. 이름과 입사일과 직위만 다르고 나머지 문장은 토씨 하나까지 같습니다. 총무팀이 매년 발송하는 위원 위촉장도, 교육담당자가 과정이 끝날 때마다 만드는 수료증도, 영업팀이 거래처별로 찍어 내는 견적서 표지도 사정이 다르지 않습니다. 공통점은 하나입니다. 서식은 이미 완성되어 있고 바뀌는 것은 몇 개의 칸뿐이라는 것입니다.
